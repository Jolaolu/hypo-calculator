import { type IHttpServiceConfig, type IClientOpts, StatusCodes, DEFAULT_CONTENT_TYPE } from './index.model'
...
class HttpService {
    ...
    async post<T = unknown, S = null>(url: string, opts: Omit<IClientOpts<S>, 'method' | 'payload'>): Promise<T> {
        return this._constructClient<T, S>(url, {
            ...opts,
            method: 'POST',
        })
